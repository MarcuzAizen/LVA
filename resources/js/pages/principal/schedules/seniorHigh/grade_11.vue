<template>
    <div>
        ...
        <ul class="nav nav-tabs mb-4">
            <li v-for="track in tracks" :key="track.id" class="nav-item">
                <a class="nav-link" data-toggle="tab" :href="`#${track.name}`">
                    {{ track.name }}
                </a>
            </li>
        </ul>
        <div class="tab-content">
            <div v-for="track in tracks" :key="track.id" :id="track.name" class="tab-pane fade">
