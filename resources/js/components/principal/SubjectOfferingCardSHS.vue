<template>
    <div class="card card-purple">
        ...
        <SubjectOfferingModalSHS :track="form" v-on:reload-prospectuses="$emit('reload-prospectuses')" />
    </div>
</template>

<script>
import _ from 'lodash';
import SubjectOfferingModalSHS from '../../components/principal/SubjectOfferingModalSHS';
